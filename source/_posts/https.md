...
server {
        listen 80; 
        listen 443 ssl; 
        server_name zhoufangy.github.io;
        ssl on;
        ...
        location / {
                root /home/www/zhoufangy.github.io/;
...
# index.html
<html>
<meta http-equiv="refresh" content="0;url=https://zhoufangy.github.io/">
</html>
...
server {  
    ...
    #将404的页面重定向到https的首页
    error_page  404 https://zhoufangy.github.io/;
}
{% endcodeblock %}
以上四种方法
